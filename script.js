(function (document, window) {
	...
	var animate = function (minTimeDelta, func) {
		var stop = true;
		var speed = 0;
		var time = 0;
	...
	var getHTML = function (sun, planet) {
		...
		if (planet.description) {
			html += '<div class=description>' + planet.description + '</div>';
		}
		html += "<dl>";
	...
	var main = function (shaderSources, textures) { // main()
		...
		var sun = {
			name: "Sun",
			description: "The Sun is the star at the center of the Solar System, a nearly perfect sphere of hot plasma heated by nuclear fusion reactions in its core.",
			luminosity: 3846e23,
			radius: 1392684,
			...
			satellites: [
				{
					name: "Mercury",
					description: "Mercury is the smallest and innermost planet in the Solar System, with a heavily cratered surface due to impacts from comets and asteroids.",
					radius: 4878 / 2,
				...
				{
					name: "Venus",
					description: "Venus is the second planet from the Sun, with a thick atmosphere that traps heat in a runaway greenhouse effect, making it the hottest planet in our solar system.",
					radius: 12104 / 2,
				...
				{
					name: "Earth",
					description: "Earth is the third planet from the Sun and the only astronomical object known to harbor life, with liquid water covering 71% of its surface.",
					radius: 12756 / 2,
				...
				{
					name: "Mars",
					description: "Mars is the fourth planet from the Sun, known as the 'Red Planet' due to the iron oxide prevalent on its surface, which gives it a reddish appearance.",
					...
					satellites: [
						{
							name: "Phobos",
							description: "Phobos is the innermost and larger of the two natural satellites of Mars, with an irregular shape and heavily cratered surface.",
							radius: 11.2667 / 2,
				...
				{
					name: "Jupiter",
					description: "Jupiter is the fifth planet from the Sun and the largest in the Solar System, with a mass more than two and a half times that of all the other planets combined.",
					radius: 1427960 / 2,
				...
				{
					name: "Saturn",
					description: "Saturn is the sixth planet from the Sun, known for its extensive ring system composed mainly of ice particles with a smaller amount of rocky debris and dust.",
					radius: 120660 / 2,
				...
				{
					name: "Uranus",
					description: "Uranus is the seventh planet from the Sun, with a unique sideways rotation that causes extreme seasons lasting over 20 years.",
					radius: 51118 / 2,
				...
				{
					name: "Neptune",
					description: "Neptune is the eighth and farthest known planet from the Sun, with the strongest winds of any planet in the Solar System, reaching speeds of almost 2,100 km/h.",
					radius: 48600 / 2,
		...
		var animation = animate(1e3 / 120, draw).start();
